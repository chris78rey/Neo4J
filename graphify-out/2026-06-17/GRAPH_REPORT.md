...
## Corpus Check
- 54 files · ~11,535 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 390 nodes · 844 edges · 38 communities (33 shown, 5 thin omitted)
...
Cohesion: 0.16
Nodes (25): Pipeline, PipelineResult, extract_entities(), extract_relations(), extract_semantic_entities(), extract_signatures(), extract_structured_fields(), Chunk (+17 more)
...
Cohesion: 0.11
Nodes (27): ArgumentParser, Namespace, build_parser(), cmd_ask(), cmd_ingest(), main(), ingest_document(), build_chunks() (+19 more)
...
Cohesion: 0.06
Nodes (6): Neo4jGraphStore, QdrantVectorStore, Chunk, Document, Entity, Relation
