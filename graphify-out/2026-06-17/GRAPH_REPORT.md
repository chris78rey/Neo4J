...
## Corpus Check
- 53 files · ~11,072 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 385 nodes · 821 edges · 39 communities (33 shown, 6 thin omitted)
...
Cohesion: 0.11
Nodes (40): ArgumentParser, BackgroundTasks, BaseModel, Namespace, ask_question(), AskResponse, current_ingest_timestamp(), delete_document() (+32 more)
...
Cohesion: 0.18
Nodes (26): Any, build_embeddings(), is_signature_question(), chat(), embeddings(), enabled(), OpenRouterConfig, _request() (+18 more)

### Community 34 - "Community 34"
Cohesion: 0.12
Nodes (14): build_chunks(), chunk_text(), load_document(), InMemoryVectorStore, Chunk, Document, test_extract_entities_and_relations(), test_inmemory_healthchecks() (+6 more)
...
- **Why does `Document` connect `Community 21` to `Community 1`, `Community 34`, `Community 26`, `Community 38`?**
